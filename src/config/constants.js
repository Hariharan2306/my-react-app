...
export const randomNames = [
  {
    ...
    starRating: "★★★★★",
    about:
      "I am Alice, a diligent bus driver ensuring safe travels for passengers.",
  },
  {
    name: "Bob",
    age: 31,
    ...
    starRating: "★★★☆☆",
    about:
      "I am Bob, committed to providing reliable transportation as a bus driver.",
  },
  {
    name: "Charlie",
    age: 34,
    ...
    starRating: "★★★★☆",
    about:
      "I am Charlie, dedicated to delivering passengers safely as a bus driver.",
  },
  {
    name: "Diana",
    age: 38,
    ...
    starRating: "★★☆☆☆",
    about:
      "I am Diana, ensuring comfortable journeys for passengers as a bus driver.",
  },
  {
    name: "Ethan",
    age: 32,
    ...
    starRating: "★★★★★",
    about:
      "I am Ethan, focused on passenger safety and satisfaction as a bus driver.",
  },
  {
    name: "Fion",
    age: 28,
    ...
    starRating: "★★★★☆",
    about:
      "I am Fion, dedicated to providing smooth rides for passengers as a bus driver.",
  },
  {
    name: "George",
    age: 48,
    ...
    starRating: "★★★☆☆",
    about:
      "I am George, committed to delivering exceptional service as a bus driver.",
  },
  {
    name: "Hanna",
    age: 23,
    ...
    starRating: "★★☆☆☆",
    about:
      "I am Hanna, ensuring punctual and reliable transportation as a bus driver.",
  },
  {
    name: "Iva",
    age: 25,
    ...
    starRating: "★★★★☆",
    about:
      "I am Iva, focused on providing a pleasant experience for passengers as a bus driver.",
  },
  {
    name: "Jessica",
    age: 36,
    ...
    starRating: "★☆☆☆☆",
    about:
      "I am Jessica, dedicated to ensuring passenger satisfaction and safety as a bus driver.",
  },
];
